...
from classification_model import CustomModel
...
def classify(text_tokens_list):
    ...
    config_model = ConfigModel(model_path=parent_dir+'/utils/checkpoint.pt',
                               var_models_path=parent_dir+'/utils/var_models.json')
